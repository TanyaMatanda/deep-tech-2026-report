-- FIX & OPTIMIZE: Schema Repair + Performance Boost
...
-- 2. Populate Defaults (Prevent NULLs in View)
...
-- 3. Drop Old Views (CASCADE)
DROP VIEW IF EXISTS vendor_governance.view_company_scores CASCADE;

-- 4. Create Materialized View (Pre-calculated Data)
