-- ============================================
-- DEEP TECH GOVERNANCE DATABASE - SUPABASE READY
-- For RiskAnchor Integration (Succession Economy Project)
-- ============================================

-- STEP 1: Enable UUID extension FIRST (critical!)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- STEP 2: Create vendor_governance schema
CREATE SCHEMA IF NOT EXISTS vendor_governance;

-- STEP 3: Set search path so all tables go into vendor_governance schema
...
CREATE TABLE companies (
    ...
    is_verified_cohort BOOLEAN DEFAULT FALSE, -- N=22 verified sample for report
...
CREATE TABLE governance_scores (
    ...
    -- Signal Evidence Status (Report Metadata)
    evidence_status VARCHAR(50), -- 'Validated', 'Directional', 'Diagnostic'
