...
### Critical Distinction: Grant-Date Fair Value vs. Realized Compensation

All compensation figures in this report, unless explicitly stated otherwise, reflect **grant-date fair value** as required by SEC Summary Compensation Table disclosure rules. This represents the theoretical value of equity awards at the time they are granted, calculated using Black-Scholes models for options or stock price for restricted stock units. Grant-date fair value does NOT represent cash paid to executives or the actual value executives ultimately realize.

**Realized compensation**—what executives actually receive after vesting, stock price changes, and exercise decisions—can differ dramatically from grant-date values. A CEO granted $20 million in stock awards at grant-date fair value might realize $50 million if the stock triples during the vesting period, or $5 million if it declines 75%. Beginning in 2023, the SEC requires companies to disclose "actually paid compensation" in the Pay versus Performance table, but historical data and most compensation analysis continues to use grant-date methodology.

This distinction explains apparent anomalies where stock awards appear to exceed total compensation. When a biotechnology company grants a CEO $100 million in equity scheduled to vest over four years, the full $100 million grant-date value appears in the stock awards column for the grant year, while only a portion may count toward that year's total compensation depending on the company's accounting treatment. These are reporting artifacts, not mathematical errors.
...
TG Therapeutics illustrates reporting complexities that require original filing review. The CEO's compensation record shows an extraction anomaly where component fields exceed reported totals—likely reflecting inconsistent field mapping during automated data collection or multi-year grant accounting artifacts. **Investors should consult the original DEF 14A filing and Compensation Discussion & Analysis for accurate figures.** The broader directional insight—that biotechnology compensation is equity-heavy with multi-year vesting structures—remains valid, but the specific component breakdowns for this company require manual verification.
...
**Cluster 1: Institutional Mainstream** (534-698 companies)
